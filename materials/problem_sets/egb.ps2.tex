...
\begin{parts}
    ...
    \part Using the capital, labor, GDP data and the production function, compute TFP for each year. No need to do anything here, just need to get ready for the next step.
    ...
    \part Separate each country's growth experience into two periods: 1952--1990 and 1990-2014. And for each period report: 
    \begin{itemize}
